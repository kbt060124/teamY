    ...
    public function index()
    {
        $news = UserPost::from('user_posts as p')
            ->select(
                ...
                'n.title as n_title',
                'n.news',
                DB::raw('null as r_title'),
                DB::raw('null as text'),
                DB::raw('null as recommended_name'),
                DB::raw('null as recommended_icon'),
                DB::raw('null as thanks_name'),
                DB::raw('null as thanks_icon'),
                DB::raw('null as thanks_message'),
        ...
        $thanks = UserPost::from('user_posts as p')
            ->select(
                ...
                'u.name',
                'u.icon',
                DB::raw('null as n_title'),
                DB::raw('null as news'),
                DB::raw('null as r_title'),
                DB::raw('null as text'),
                DB::raw('null as recommended_name'),
                DB::raw('null as recommended_icon'),
                'tu.name as thanks_name',
                'tu.icon as thanks_icon',
                't.message as thanks_message',
