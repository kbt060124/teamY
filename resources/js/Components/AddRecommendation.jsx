...
>
    ...
    <div>
        ...
        <div className="title font-bold">Your Future Recommendation</div>
        <div className="text">心からの「いいよ」で動き始める未来</div>
    </div>
</div>
        ...
        >
            ...
            />
                ...
                />
                    ...
                    className="w-full"
                    onChange={(e) =>
                        setData("recommendName", e.target.value)
                    }
                />
                  )}
                ...
                <div className="mx-12 mb-4 text-right absolute bottom-0 right-0">
                    <Button
                        variant="contained"
                        size="large"
                        type="submit"
